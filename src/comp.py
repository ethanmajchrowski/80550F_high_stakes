...
class AutonomousRoutines:
    ...
    red_ring_side = [[0,{'pos':[0,0],'angle':0}]]
...
class Autonomous():
    ...
    def load_path(self, sequence: str | list) -> None:
        ...
        #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        self.sequence = AutonomousRoutines.red_positive_solo_AWP
        #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        for function in self.sequence:
            ...
            if ID == 1: 
                ...
                if hasattr(TurnType, args[0]):
                    if len(args) == 3:
                        self.drivetrain.turn_for(getattr(TurnType, args[0]), args[1])
