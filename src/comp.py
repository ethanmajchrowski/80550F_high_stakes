...
class AutonomousHandler:
    ...
    def run(self):
        ...
        #     paths = {
        #         "mogo": {
        #             "points": ((1364.92, -903.03), (1288.34, -926.08), (1210.19, -943.0), (1130.73, -951.5), (1051.09, -945.43), (975.61, -919.81), (910.79, -873.42), (857.86, -813.62), (812.89, -747.49), (770.68, -679.53), (726.83, -612.63), (678.11, -549.2), (622.46, -491.81), (540.82, -429.93)),
        #         }, 
        #         "final": {
        #             # "points": ((565.08, -586.15), (630.36, -632.16), (674.04, -697.79), (665.57, -775.68), (626.23, -845.2), (582.33, -912.08), (546.18, -983.27), (529.35, -1061.08), (542.68, -1139.45), (579.49, -1210.13), (630.35, -1271.74), (690.25, -1324.62), (754.59, -1372.07), (823.41, -1412.74), (897.62, -1442.36), (975.48, -1460.14), (1055.33, -1462.34), (1134.68, -1452.81), (1213.09, -1436.96), (1291.7, -1422.24), (1371.38, -1417.16), (1450.27, -1428.74), (1524.28, -1458.64), (1591.14, -1502.28), (1651.31, -1554.87), (1706.33, -1612.87), (1757.31, -1674.48), (1805.27, -1738.49), (1862.27, -1822.3)),
        #             "points": ((565.08, -586.15), (629.56, -633.3), (674.66, -698.11), (670.83, -776.24), (632.18, -846.1), (587.36, -912.36), (549.23, -982.53), (530.52, -1059.88), (542.32, -1138.41), (578.79, -1209.27), (629.6, -1270.93), (691.69, -1321.03), (755.75, -1368.95), (820.56, -1415.84), (887.9, -1458.98), (959.4, -1494.76), (1034.07, -1523.43), (1110.01, -1548.57), (1186.42, -1572.26), (1262.97, -1595.53), (1339.53, -1618.73), (1416.06, -1642.03), (1492.53, -1665.51), (1609.1, -1701.69)),
        #         }, 
        #         "backup": {
        #             "points": ((1825.24, -1821.48), (1772.71, -1761.15), (1719.06, -1701.81), (1663.33, -1644.42), (1602.39, -1592.76), (1530.86, -1557.3), (1451.4, -1493.12)),
        #         },
        #         "ram_again": {
        #             "points": ((1283.53, -1495.91), (1357.37, -1526.68), (1429.76, -1560.71), (1500.36, -1598.32), (1569.02, -1639.36), (1636.01, -1683.08), (1701.95, -1728.39), (1767.47, -1774.28), (1853.28, -1833.95)),
        #         }, 
        #         "backup_long": {
        #             "points": ((1825.24, -1821.48), (1771.87, -1761.9), (1716.01, -1704.65), (1656.88, -1650.79), (1593.85, -1601.57), (1526.66, -1558.22), (1455.57, -1521.59), (1382.56, -1488.88), (1311.5, -1452.24), (1232.66, -1391.38)),
        #         }
        #     }

        #     # blue
        #     self.dynamic_vars["intake_color_sort"] = "eject_red"
        #     self.dynamic_vars["position"] = [1401, -901]
        #     imu.set_heading(90)
        #     # red
        ...
        #     self.dynamic_vars["fwd_speed"] = 8.5
        #     print("path mogo")
        #     self.path(paths["mogo"]["points"], [], [], True)
        #     mogo_pneu.set(True)
        #     sleep(200, MSEC)
        #     brain.timer.event(motors["misc"]["intake_chain"].spin, 150, (DirectionType.FORWARD, 65, VelocityUnits.PERCENT))
        #     motors["misc"]["intake_flex"].spin(DirectionType.FORWARD, 100, VelocityUnits.PERCENT)
        #     self.dynamic_vars["fwd_speed"] = 5
        #     print("path final")
        #     self.path(paths["final"]["points"], [], [], False, 350, 100, 75, 4000)
        ...
        #     drivetrain.turn(TurnType.LEFT, 60, VelocityUnits.PERCENT)
        #     sleep(1200, MSEC)
        #     drivetrain.stop()
        ...
        #         "final": {
        #             # "points": ((565.08, -586.15), (630.36, -632.16), (674.04, -697.79), (665.57, -775.68), (626.23, -845.2), (582.33, -912.08), (546.18, -983.27), (529.35, -1061.08), (542.68, -1139.45), (579.49, -1210.13), (630.35, -1271.74), (690.25, -1324.62), (754.59, -1372.07), (823.41, -1412.74), (897.62, -1442.36), (975.48, -1460.14), (1055.33, -1462.34), (1134.68, -1452.81), (1213.09, -1436.96), (1291.7, -1422.24), (1371.38, -1417.16), (1450.27, -1428.74), (1524.28, -1458.64), (1591.14, -1502.28), (1651.31, -1554.87), (1706.33, -1612.87), (1757.31, -1674.48), (1805.27, -1738.49), (1862.27, -1822.3)),
        #             "points": ((-565.08, -586.15), (-629.56, -633.3), (-674.66, -698.11), (-670.83, -776.24), (-632.18, -846.1), (-587.36, -912.36), (-549.23, -982.53), (-530.52, -1059.88), (-542.32, -1138.41), (-578.79, -1209.27), (-629.6, -1270.93), (-696.34, -1250.62), (-766.86, -1212.86), (-838.4, -1177.07), (-911.05, -1143.61), (-984.92, -1112.92), (-1060.08, -1085.54), (-1136.82, -1062.99), (-1214.92, -1045.83), (-1294.24, -1036.01), (-1374.15, -1036.91), (-1452.34, -1052.79), (-1523.82, -1087.85), (-1581.1, -1143.1), (-1619.6, -1212.87), (-1641.33, -1289.65), (-1651.0, -1368.99), (-1647.95, -1496.4)),
        #         }, 
        #         "backup": {
        #             "points": ((1825.24, -1821.48), (1772.71, -1761.15), (1719.06, -1701.81), (1663.33, -1644.42), (1602.39, -1592.76), (1530.86, -1557.3), (1451.4, -1493.12)),
        #         },
        ...
        # print("backup 1")
        # self.path(paths["backup"]["points"], [], [], True, 350, 100, 75)
        # self.dynamic_vars["fwd_speed"] = 7
        # print("ram_again")
        # self.path(paths["ram_again"]["points"], [], [], False, 350, 100, 75, 2000)
        # sleep(1500, MSEC)
        # self.dynamic_vars["fwd_speed"] = 3
        # print("last backup")
        # self.path(paths["backup_long"]["points"], [], [], True, 350, 100, 75)
        # sleep(2000, MSEC)
        # motors["misc"]["intake_flex"].stop()
        # motors["misc"]["intake_chain"].stop()
        # print("done")
...
def odom_logging_thread():
    while True:
        ...
        data = {
            ...
            "theta": round(radians(imu.rotation()), 2)
        }
