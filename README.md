# 80550F
## Overview
Codebase for team 80550F and the High Stakes Season.
Handles infrastructure, autonomous routines, user input, and state management. Autonomous routines mainly use Pure Pursuit for movement and tracking wheels + inertial sensor for localization.
...
<img src="resources/VEX_Fractal_Logo.jpg" alt="VEX Fractal Logo" width="200">
...
- `Autonomous` class manages all the autons, including setup, execution of the sequence, and cleanup. Also contains the main logic of the `path` function for driving paths with pure pursuit
  ...
  - `main()` is the actual entry point for the code. It basically sets up the robot object and then determines:
...
- We make our autonomous routes using a custom built GUI [here]([https://github.com/ethanmajchrowski/80550F_high_stakes](https://github.com/ethanmajchrowski/VEX-Autonomous-GUI))
