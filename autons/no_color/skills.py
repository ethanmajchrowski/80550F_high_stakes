...
def run(main):
    ...
    # drop mogo in corner
    controller.path(paths[7], backwards=True, timeout=850)
    pneumatic.mogo.set(False)
    ...
    controller.path(paths[8], speed_ramp_time=1000, min_start_voltage=2.5, timeout=7000, slowdown_distance=1000, look_ahead_dist=400,)
    ...
    controller.path(paths[12], speed_ramp_time=400, slowdown_distance=800)
    motor.intakeChain.stop()
    controller.fwd_speed = 7
