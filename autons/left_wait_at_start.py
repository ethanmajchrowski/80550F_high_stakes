# This code waits momentarily at the start before placing our preload on the alliance
# stake (2 sec) in order to allow an alliance partner to score on the alliance stake before us
...
def gen_paths(main):
        paths = {
            ...
            "mogo_align": {
                "points": ((-1583.0, 30.0), (-1473.24, -50.19), (-1354.73, -75.11), (-1243.95, -100.88), (-1156.52, -100.15), (-1090.29, -100), (-1043.82, 0.25), (-1013.77, 200.29), (-998.07, 544.1), (-996.86, 663.91), (-1011.33, 782.82), (-1043.69, 898.16), (-1099.89, 1003.71), (-1192.04, 1102.49)),
            ...
            "fill_mogo": {
                # 2 Ring:
                "points": ((-500.0, 475.0), (-611.26, 559.97), (-714.31, 654.51), (-792.3, 769.83), (-801.87, 907.22), (-742.33, 1032.87), (-650.92, 1138.67)),
            ...
            "touch_ladder": {
                "points": ((-615.56, 1251.76), (-611.08, 1121.85), (-613.38, 991.9), (-622.95, 862.3), (-640.82, 733.58), (-670.67, 607.16), (-716.59, 485.73), (-792.83, 381.38), (-913.01, 345.88), (-1028.73, 400.34), (-1095.4, 459.26)),
                "events": [],
                "checkpoints": [],
                "custom_args": (True,)
            },
            "touch": {
                "points": ((-1081.26, 459.26), (-985.94, 370.85), (-890.63, 282.45), (-795.32, 194.04), (-700.01, 105.63), (-593.42, 6.77)),
                "events": [],
                "checkpoints": [],
                "custom_args": (False,)
            },
